...
### Loess predictions
The gold prediction for 2012 is `r format(loess_prediction("gold"), digits = 3, nsmall = 1)` seconds, for silver is `r format(loess_prediction("silver"), digits = 3, nsmall = 1)` seconds, and for bronze is `r format(loess_prediction("bronze"), digits = 3, nsmall = 1)`.
